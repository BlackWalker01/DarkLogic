...
DbTheorem::DbTheorem()
{
	...
	add("Modus ponens", "((a=>b)&&a)=>b", 750);
	add("Identity", "a<=>a", 800);
	add("DoubleNot", "a<=>!!a", 850);
	add("Identity and True", "(a<=>a)&&True", 950);
	add("Double-Not and True", "(a<=>!!a)&&True", 950);
	add("Identity-Double-Not", "(a<=>a)&&(a<=>!!a)", 1000);
	add("Semi-Identity and Semi-Double-Not", "(a=>a)&&(a=>!!a)", 1250);
	add("Semi-Identity and Semi-Double-Not and True", "(a=>a)&&(a=>!!a)&&True", 1600);
	add("Contraposition", "(a=>b)=>(!b=>!a)", 1900);
	add("Double-And", "a&&a<=>a", 1950);
	add("Contraposition and True", "((a=>b)=>(!b=>!a))&&True", 2000);
	add("ExcludedMiddle", "a||!a", 2150);
	add("Semi-Double-Or", "a||a=>a", 2900);
	add("Double-or", "a||a<=>a", 3100);
	add("Modus tollens", "((a=>b)&&!b)=>!a", 3100);
	add("Peirce law", "((a=>b)=>a)=>a", 3100);
	add("Modus barbara", "((a=>b)&&(b=>c))=>(a=>c)", 3150);
	add("Semi-De Morgan law [R]", "!(a&&b)=>(!a||!b)", 3150);
	add("Semi-De Morgan law [L]", "(!a||!b)=>!(a&&b)", 3150);
	add("Semi-De Morgan law (2) [R]", "!(a||b)=>(!a&&!b)", 3150);
	add("Semi-De Morgan law (2) [L]", "(!a&&!b)<=>!(a||b)", 3150);
	add("De Morgan law", "!(a&&b)<=>(!a||!b)", 3350);
	add("De Morgan law (2)", "!(a||b)<=>(!a&&!b)", 3450);
	add("&& Distributivity", "(a&&(b||c))<=>((a&&b)||(a&&c))", 3550);
	add("|| Distributivity", "(a||(b&&c))<=>((a||b)&&(a||c))", 3550);
}
