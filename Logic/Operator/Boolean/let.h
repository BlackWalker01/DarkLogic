...
template<typename SubRuleType>
const ptr<IISubRuleFormula> &N_Logic::LetFun<SubRuleType, ASubRule>::
...
template<typename SubRuleType>
const ptr<IISubRuleFormula> &N_Logic::Let<SubRuleType, ASubRule>::
operator[](const size_t &k) const
{
    return this->m_fun[k];
}
...
template<typename SubTheoremType>
const ptr<IISubTheoremFormula> &N_Logic::LetFun<SubTheoremType, ASubTheorem>::
operator[](const size_t &k) const
{
    switch(k)
    {
