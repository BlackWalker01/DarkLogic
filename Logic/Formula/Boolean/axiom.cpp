...
ptr<ASubRule> N_Logic::createAxiom(const std::string &name, const std::string &content)
{
    //parse hypothesis
    char c='\0';
...
ptr<ASubRule> N_Logic::createAxiom(const std::string &name, std::vector<OperatorOrdering> &opeList,
