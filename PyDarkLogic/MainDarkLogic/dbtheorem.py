...
class DbTheorem:
    def __init__(self):
        ...
        self.addTheorem("Identity-Double-Not", "(a<=>a)&&(a<=>!!a)", 2350)
        self.addTheorem("ExcludedMiddle", "a||!a", 2550)
        self.addTheorem("Peirce law", "((a=>b)=>a)=>a", 2550)
        self.addTheorem("Modus ponens", "((a=>b)&&a)=>b", 2550)
        self.addTheorem("De Morgan law", "!(a&&b)<=>(!a||!b)", 2650)
        self.addTheorem("De Morgan law (2)", "!(a||b)<=>(!a&&!b)", 2750)
        self.addTheorem("Modus tollens", "((a=>b)&&!b)=>!a", 2800)
        self.addTheorem("Modus barbara", "((a=>b)&&(b=>c))=>(a=>c)", 2850)
        self.addTheorem("&& Distributivity", "(a&&(b||c))<=>((a&&b)||(a&&c))", 2850)
        self.addTheorem("|| Distributivity", "(a||(b&&c))<=>((a||b)&&(a||c))", 2850)
