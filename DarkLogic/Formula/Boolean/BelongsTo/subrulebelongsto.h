/*===--- subrulebelongsto.h - include for DarkLogic library --------------*- C++ -*-===*
*
...
*===----------------------------------------------------------------------===*
*
*   This file defines SubRule<BelongsTo> in DarkLogic Library
*   Author: BlackWalker
*   Date: april 12 2020
*
*===----------------------------------------------------------------------===*/

#ifndef DARK_LOGIC_SUBRULEBELONGSTO_H
#define DARK_LOGIC_SUBRULEBELONGSTO_H
...
template<typename SetType>
const ptr<IISubRuleFormula> &N_DarkLogic::SubRule<BelongsTo<ASubArithmeticRule<typename SetType::Type>, ASubArithmeticRule<SetType> > >::
...
#endif // DARK_LOGIC_SUBRULEBELONGSTO_H
