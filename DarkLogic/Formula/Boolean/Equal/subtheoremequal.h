/*===--- subtheoremequal.h - include for DarkLogic library --------------*- C++ -*-===*
*
...
*===----------------------------------------------------------------------===*
*
*   This file defines SubTheorem<Equal> in DarkLogic Library
*   Author: BlackWalker
*   Date: april 12 2020
*
*===----------------------------------------------------------------------===*/

#ifndef DARK_LOGIC_SUBTHEOREMEQUAL_H
#define DARK_LOGIC_SUBTHEOREMEQUAL_H
...
template<typename ValueType1, typename ValueType2>
N_DarkLogic::SubTheorem<Equal<ASubArithmeticTheorem<ValueType1>, ASubArithmeticTheorem<ValueType2> > >::
SubTheorem(const ptr<ASubArithmeticTheorem<ValueType1>> &leftFormula,
           const ptr<ASubArithmeticTheorem<ValueType2>> &rightFormula):
...
template<typename ValueType1, typename ValueType2>
size_t N_DarkLogic::SubTheorem<Equal<ASubArithmeticTheorem<ValueType1>, ASubArithmeticTheorem<ValueType2> > >::arity() const
{
    return m_son->arity();
}
...
template<typename ValueType1, typename ValueType2>
std::string N_DarkLogic::SubTheorem<Equal<ASubArithmeticTheorem<ValueType1>, ASubArithmeticTheorem<ValueType2> > >::
...
template<typename ValueType1, typename ValueType2>
const DbVar* N_DarkLogic::SubTheorem<Equal<ASubArithmeticTheorem<ValueType1>, ASubArithmeticTheorem<ValueType2> > >::getExtVars() const
{
    return &m_extVars;
}
...
template<typename ValueType1, typename ValueType2>
bool N_DarkLogic::SubTheorem<Equal<ASubArithmeticTheorem<ValueType1>, ASubArithmeticTheorem<ValueType2> > >::
...
N_DarkLogic::SubTheorem<Equal<ASubArithmeticTheorem<ValueType1>, ASubArithmeticTheorem<ValueType2> > >::computeAllPaths()
{
    if(!m_allPaths.size())
    {
...
template<typename ValueType1, typename ValueType2>
const std::vector<std::vector<Arity> >&
N_DarkLogic::SubTheorem<Equal<ASubArithmeticTheorem<ValueType1>, ASubArithmeticTheorem<ValueType2> > >::computeImplPaths()
{
    if (!m_implPaths.size())
    {
...
template<typename ValueType1, typename ValueType2>
const ptr<IISubTheoremFormula> &N_DarkLogic::SubTheorem<Equal<ASubArithmeticTheorem<ValueType1>, ASubArithmeticTheorem<ValueType2> > >::
...
#endif // DARK_LOGIC_SUBTHEOREMEQUAL_H
