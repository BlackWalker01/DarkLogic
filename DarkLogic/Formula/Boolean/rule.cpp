...
void ASubRule::addAbstractTerm(const std::string &varName, std::vector<std::shared_ptr<VariableContainer>> &varList, N_DarkLogic::DbVarContainer &dbVar)
{
...
ptr<ASubRule> N_DarkLogic::createRule(const std::string &name, const std::string &content)
{
    //parse hypothesis
    char c='\0';
...
ptr<ASubRule> N_DarkLogic::createRule(const std::string &name, std::vector<OperatorOrdering> &opeList,
