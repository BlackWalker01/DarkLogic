/*===--- equal.h - header for DarkLogic library --------------*- C++ -*-===*
*
...
*===----------------------------------------------------------------------===*
*
*   This file defines equal operator in DarkLogic Library
*   Author: BlackWalker
*   Date: april 12 2020
*
*===----------------------------------------------------------------------===*/

#ifndef DARK_LOGIC_EQUAL_H
#define DARK_LOGIC_EQUAL_H
...
/**
  ...
  */
template<typename ValueType1, typename ValueType2>
std::string N_DarkLogic::EqualFun<ASubArithmeticTheorem<ValueType1>, ASubArithmeticTheorem<ValueType2> >::symbol()
{
    return EqualToStr::s_symbol;
}

template<typename SubValueType>
std::string N_DarkLogic::EqualFun<ASubArithmeticTheorem<SubValueType>, ASubArithmeticTheorem<SubValueType> >::symbol()
{
    return EqualToStr::s_symbol;
}

template<typename ValueType1, typename ValueType2>
std::string N_DarkLogic::EqualFun<ASubArithmeticRule<ValueType1>, ASubArithmeticRule<ValueType2> >::symbol()
{
    return EqualToStr::s_symbol;
}

template<typename SubValueType>
std::string N_DarkLogic::EqualFun<ASubArithmeticRule<SubValueType>, ASubArithmeticRule<SubValueType> >::symbol()
{
    return EqualToStr::s_symbol;
}
...
N_DarkLogic::EqualFun<ASubArithmeticRule<ValueType1>, ASubArithmeticRule<ValueType2> >::operator[](const size_t &k) const
{
    switch(k)
    {
        case 0:
...
template<typename SubValueType>
const ptr<IISubRuleFormula > &
N_DarkLogic::EqualFun<ASubArithmeticRule<SubValueType>, ASubArithmeticRule<SubValueType> >::operator[](const size_t &k) const
{
    switch(k)
    {
        case 0:
...
template<typename SubValueType>
const ptr<IISubTheoremFormula > &N_DarkLogic::EqualFun<ASubArithmeticTheorem<SubValueType>,
