/*===--- belongsto.h - header for DarkLogic library --------------*- C++ -*-===*
*
...
*===----------------------------------------------------------------------===*
*
*   This file defines belongsTo operator in DarkLogic Library
*   Author: BlackWalker
*   Date: april 12 2020
*
*===----------------------------------------------------------------------===*/

#ifndef DARK_LOGIC_BELONGSTO_H
#define DARK_LOGIC_BELONGSTO_H
...
template<typename SetType>
const ptr<IISubTheoremFormula> &N_DarkLogic::BelongsTo<ASubArithmeticTheorem<typename SetType::Type>, ASubArithmeticTheorem<SetType> >::
operator[](const size_t &k) const
{
    return this->m_fun[k];
}
