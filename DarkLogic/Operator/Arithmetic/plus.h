/*===--- plus.h - header for DarkLogic library --------------*- C++ -*-===*
*
...
*===----------------------------------------------------------------------===*
*
*   This file defines plus operator in DarkLogic Library
*   Author: BlackWalker
*   Date: april 12 2020
*
*===----------------------------------------------------------------------===*/
...
template<typename ValueType1, typename ValueType2>
std::string N_DarkLogic::PlusFun<ASubArithmeticRule<ValueType1>, ASubArithmeticRule<ValueType2> >::symbol()
{
    return PlusToStr::s_symbol;
}

template<typename ValueType>
std::string N_DarkLogic::PlusFun<ASubArithmeticRule<ValueType>, ASubArithmeticRule<ValueType> >::symbol()
{
    return PlusToStr::s_symbol;
}

template<typename ValueType1, typename ValueType2>
std::string N_DarkLogic::PlusFun<ASubArithmeticTheorem<ValueType1>, ASubArithmeticTheorem<ValueType2> >::symbol()
{
    return PlusToStr::s_symbol;
}

template<typename ValueType>
std::string N_DarkLogic::PlusFun<ASubArithmeticTheorem<ValueType>, ASubArithmeticTheorem<ValueType> >::symbol()
{
    return PlusToStr::s_symbol;
}
...
template<typename ValueType_>
const ptr<IISubRuleFormula> &N_DarkLogic::PlusFun<ASubArithmeticRule<ValueType_>, ASubArithmeticRule<ValueType_> >::operator[](const size_t &k) const
{
    switch(k)
    {
        case 0:
